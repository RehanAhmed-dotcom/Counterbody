...
import {ClientViewRFSubmit, formsubmit} from '../ApiCountoryBody/index';
...
const ClientViewRFPatient = ({navigation, route}) => {
    ...
    <>
      ...
      {formvi.message == 'Question Data' ? (
        <ScrollView
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('ClientEditViewRFPatient', {customerId});
            }}
            activeOpacity={0.8}
            style={{
              position: 'absolute',
...
export default ClientViewRFPatient;
