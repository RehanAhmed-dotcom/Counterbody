...
import {formquestion, updateuserform} from '../ApiCountoryBody';
import {
...
const EditHiTone = ({navigation, route}) => {
  ...
  const updateform = () => {
    ...
    updateuserform({token: userData.api_token, data})
      .then(res => {
...
<Cross name="circle-with-cross" color={darkmd.payload?"white":"red"} size={20}/>
  ...
  return (
    <>
      <Header top={top} navigation={navigation} title=" Edit EMS" />
